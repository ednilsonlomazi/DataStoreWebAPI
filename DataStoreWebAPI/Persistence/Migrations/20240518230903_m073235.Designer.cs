...
namespace DataStoreWebAPI.Persistence.Migrations
{
    ...
    [Migration("20240518230903_m073235")]
    partial class m073235
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataStoreWebAPI.Entities.TabItemDocumento", b =>
                {
                    ...
                    b.HasIndex("codigoDocumento", "codigoItemDocumento", "codigoObjeto", "codigoPermissao")
                        .IsUnique();
            ...
            modelBuilder.Entity("DataStoreWebAPI.Entities.TabItemDocumentoObjeto", b =>
                {
                    ...
                    b.Property<int>("tabObjetoIdObjeto")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("tabObjetoIdObjeto");
            ...
            modelBuilder.Entity("DataStoreWebAPI.Entities.TabItemDocumentoObjeto", b =>
                {
                    b.HasOne("DataStoreWebAPI.Entities.TabObjeto", "tabObjeto")
                        .WithMany()
                        .HasForeignKey("tabObjetoIdObjeto")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
